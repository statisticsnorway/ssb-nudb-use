...
from nudb_use.metadata.nudb_klass.klass_utils import _resolve_date_range
...
def generate_test_variable(
    ...
    has_rename = renamed_from is not None and renamed_from  # Can be None, or an empty list
