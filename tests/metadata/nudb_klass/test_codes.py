...
def subtest_check_klass_codes(df: pd.DataFrame) -> None:
    ...
    klass_metadata: pd.DataFrame = metadata.query("klass_codelist.notna() & klass_codelist > 0")
