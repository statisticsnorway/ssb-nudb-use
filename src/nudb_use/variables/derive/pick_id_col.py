...
def detect_pers_id_fnr_used(pers_id_fnr: pd.Series) -> Literal["pers_id"] | Literal["fnr"]:
    ...
    if common_width == 7:
        ...
        raise ValueError(f"What sort of personal id has {common_width} as the most common width? We only support pers_id (snr) or fnr.")