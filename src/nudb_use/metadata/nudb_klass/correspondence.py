...
def klass_correspondence_to_mapping(var_meta: Variable) -> dict[str, str]:
    ...
    correspondence_maybe_none: str | None = var_meta.klass_correspondence_to
    ...
    correspondence = klass.KlassCorrespondence(
        ...
        # from_date=?,  # Future development, do we want to pass time down to this function to not always get the latest versions?
        # to_date=?,
    )
